  ...
  return (
    <Container>
      ...
      <IconsContainer>
        ...
        <IconContainer>
          <SimpleLineIcons name="user-follow" size={20} color="gray" />
          <Text style={{ color: "gray" }}>Update Info</Text>
        </IconContainer>
        <IconContainer>
          <SimpleLineIcons name="chart" size={20} color="gray" />
          <Text style={{ color: "gray" }}>Activity Log</Text>
        </IconContainer>
        <IconContainer>
